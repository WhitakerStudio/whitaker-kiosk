...
viewOpts = {"title":0,"page":0,"zoom":0,"fs":1,"pdf":0,"toc":129,"thumbs":1,"progress":0,"showbar":1,"bg":"#000","loadText":"loading content...","footer":0};
...
function initPageMode(){
	if(multifile){
		...
		initPageFlip();
// FIX for GH492
		$sl.turn("disable",!0).on('turning start',function(e,n,v){ window.turning=!0; $sl.find('audio,video').each(function(i, elem){elem.player?.setControlsSize()})}).on('end',function(e,n,v){window.turning=!1;}).on('turned',function(e,n,v){ 
...
function addNavProps(){
	if(nav.numPages === undefined) nav.numPages=129;
...
function exitFullscreen() {
  $('html').css('overflow', ''); // ADDED BY CW/CAT 12-2-25
